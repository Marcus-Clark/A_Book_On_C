 ...
 * NOTES on Antiquity:
 *
 *   - The early C syntax didn't allow for combining type intofmation
 *     in the parenthesized argument list only the names were listed.
 *     Then a "variable" list followed the () and preceded the { that
 *     declared the types for the agument list.
 *
 *   - There was no "void", specifically there is no distinction
...
/*** Lets make some assumptions about our terminal columns and lines. ***/

#define T_COLS  80
#define T_LINES 24

/*** Lets setup our global working environment ***/
